...
class PropsTable extends Main\Entity\DataManager
{
    /**
    ...
    public static function getMap()
    {
        return array(
            'ID' => array(
                ...
                'primary' => true,
                'autocomplete' => true,
                'title' => Loc::getMessage('PROPS_ENTITY_ID_FIELD'),
            ),
            'UID' => array(
                'data_type' => 'string',
                'required' => true,
                'validation' => array(__CLASS__, 'validateUid'),
                'title' => Loc::getMessage('PROPS_ENTITY_UID_FIELD'),
            ),
            'JSON' => array(
                'data_type' => 'text',
                'required' => true,
                'title' => Loc::getMessage('PROPS_ENTITY_JSON_FIELD'),
            ),
        );
    }
    /**
