...
var Header = {
    ...
    headerScroll: function headerScroll() {
        var topPosition = this.topBanner ? this.topBanner.height() : 0,
            ...
            scrollShift = window.innerWidth > 1023 ? 45 : 0,
            //header__top height
    ...
    dropdownBrandsScroll: function dropdownBrandsScroll() {
        this.dropdownBrands.jScrollPane({
            autoReinitialise: true
        });

        this.menuItem.hover(function () {
            ...
            $dropdown.find('.nav-dropdown__brands-inner').css({ 'max-height': maxHeight + 'px' });
        });
    },

    setSvgNavColor: function setSvgNavColor() {
    ...
    searchFormState: function searchFormState() {
...
var MainJs = {
    ...
    fancyboxPopup: function fancyboxPopup() {
    ...
    footerAccordion: function footerAccordion() {
    ...
    footerAccordionClean: function footerAccordionClean() {
        if (window.innerWidth > 640) {
            $('.footer-nav__title').removeClass('active').next().css('display', '');
        }
    },

    setImageSrc: function setImageSrc($imagesCollection) {
    ...
    mobileScrollSliderMedia: function mobileScrollSliderMedia(swiperOptions) {
    ...
    suggestionMore: function suggestionMore() {
        var _this = this;
    ...
    productsMore: function productsMore() {
        var _this = this;
    ...
    scrollSliderInit: function scrollSliderInit() {
        var _this = this;
        ...
        $(window).on('load resize', function () {
            $(_this.scrollSlider).each(function () {
                ...
                if (window.innerWidth <= 1440) {
                    ...
                    $sliderWripper.append($slideCollecitons.first().clone().addClass('swiper-slide__duplicated')).prepend($slideCollecitons.last().clone().addClass('swiper-slide__duplicated'));
                }
    ...
    salesSliderInit: function salesSliderInit() {
        var _this = this;
    ...
    tabsInit: function tabsInit() {
        ...
        $(this.tabBtn).on('click', function () {
            ...
            if (_this.scrollSliderObj) {
                $(this).closest(_this.tabWrapper).find('.panel.active ' + _this.scrollSlider).get(0).swiper.update();
    ...
    checkedInput: function checkedInput() {
    ...
    inspectionInputs: function inspectionInputs(arr) {
    ...
    categoryBannerInit: function categoryBannerInit() {
        var src = '';
    ...
    breadcrumbsInit: function breadcrumbsInit() {
    ...
    setDescriptionsMaxHeight: function setDescriptionsMaxHeight() {
        var _this = this;
    ...
    setMaxHeights: function setMaxHeights(els) {
